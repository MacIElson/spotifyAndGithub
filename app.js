...
app.get('/getFileSHAs', authRoute.ensureAuthenticated, indexRoute.stripUserArray, indexRoute.attachGithubApi, indexRoute.getFileSHAs);
...
app.post('/restorePlaylist', authRoute.ensureAuthenticated, indexRoute.stripUserArray, indexRoute.attachSpotifyApi, indexRoute.attachGithubApi, indexRoute.restorePlaylist)
